/*
 * Flash mapping for RTL8672 boards
 *
 * $Id: rtl8672_flash.c,v 1.1 2010/07/06 03:11:50 c65985 Exp $
 */
...
static struct mtd_partition rtl8672_parts[] = {
	...
	{ name: "flag", offset:  0x10000 ,size:  0x1000, mask_flags: 0 },
#ifdef CONFIG_4M_FLASH
#ifdef CONFIG_64KB_CONF_PART
	{ name: "rootfs", offset:  0x11000, size:0x3E0000,mask_flags:0},
	{ name: "config", offset: 0x3F1000, size: 0xF000,mask_flags:0},
#else
	{ name: "rootfs", offset:  0x11000, size:0x3EF000,mask_flags:0},
#endif
#else
#ifdef CONFIG_64KB_CONF_PART
	{ name: "rootfs", offset:  0x11000, size:0x1DF000,mask_flags:0},
	{ name: "config", offset: 0x1F0000, size: 0x10000,mask_flags:0},
#else
	{ name: "rootfs", offset:  0x11000, size:0x1EF000,mask_flags:0},
#endif
#endif
};
...
u32 rtl8672_flash_bank(u32 address)
{
	...
	bank = address >> 22;
       ...
       val = *(volatile int *)0xb8003310;
       *(volatile int *)0xb8003310 =  val|(1 << 12);
