 ...
 */
 ...
 /*start of modify by z00166803 2010-7-19 for usb problem with data card.
   patch from new version of kernel is patched */
...
/*end of modify by z00166803 2010-7-19 for usb problem with data card.
 *patch from new version of kernel is patched */
...
free_interfaces:
	...
	usb_set_device_state(dev, USB_STATE_CONFIGURED);
        ...
        if( ((0x12d1 == dev->descriptor.idVendor)||(0xd112 == dev->descriptor.idVendor)) &&  !atomic_read(&g_iDataCardIn))
        {
            printk("\n==find hw card===\n");
