 ...
 *
 * $Id: usb.c,v 1.2 2010/11/22 03:13:12 l43571 Exp $
 *
...
#if 1
            //printk("\n==file:%s,line:%d,func:%s=g_iDataCardIn=%d==\n",__FILE__,__LINE__,__FUNCTION__,g_iDataCardIn);
			 ...
			 const struct usb_device_id *id)
{
	...
	US_DEBUGP("USB Mass Storage device detected\n");
        ...
        #if 0
        g_ulNumOfDataCard ++;
        /*这里之所以判断数据卡端口数是否大于2，而不是判断等于1，*/
        /*是因为有的数据卡，会上报2次mass storage*/
        //if(1 != g_ulNumOfDataCard)
        if(g_ulNumOfDataCard > 2)
        {
            g_iDataCardIn = 4 ;
        }
        #endif    
