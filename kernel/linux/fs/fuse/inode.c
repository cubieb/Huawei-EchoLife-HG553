...
/*added by  lvxin 00135113@20081227 
if kernel version=2.6.21 then
use ifndef UMOUNT_BEGIN_VFSMOUNT
else use #ifdef UMOUNT_BEGIN_VFSMOUNT*/
#ifndef UMOUNT_BEGIN_VFSMOUNT
