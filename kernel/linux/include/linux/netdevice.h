 ...
 */
	...
	int			(*hard_start_xmit2) (struct sk_buff *skb,
						    struct net_device *dev);
#endif
...
#define BIND_RELAY_NUM 16 //CONNECT_OPTION60_MAX
struct bind_relay
{
	char acWanName[BIND_RELAY_NUM][IFNAMSIZ + 1];  
	int iEnable[BIND_RELAY_NUM];  //设备类型
};
extern struct bind_relay g_bindrelay;
#endif
#endif
