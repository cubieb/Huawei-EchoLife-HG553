...
static int br2684_start_xmit(struct sk_buff *skb, struct net_device *dev)
{
    ...
    /* start of wan data added by y42304 20060522: 处理WAN data led */        
    //if (kLedStateOff == kerSysGetLedState(kLedWanDataFail))
    {
    ...
    /* end of wan data added by y42304 20060522 */
	...
	if (brvcc == NULL) {
       ...
       if (qos_enable)
       {
           if ( !(skb->mark & MARK_VOICE_FILTER))
           {
                   /*为规避语音报文如imq导致阻塞问题，临时让语音报文不入imq*/
