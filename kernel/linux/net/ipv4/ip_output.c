 ...
 *
 * Version:	$Id: ip_output.c,v 1.1 2010/07/06 06:45:39 c65985 Exp $
 *
 * Authors:	Ross Biro
...
/* add fast routing by f00110348 */
extern int sysctl_fast_routing;
/* begin, AU8D00832, s63873, 20080730*/
int sysctl_rtp_port_max = 0, sysctl_rtp_port_min = 0;
			  ...
			  __be32 saddr, __be32 daddr, struct ip_options *opt)
{
	...
	/*Start -- w00135358 add for HG255	 20090925*/
	skb->mark |= sk->mark;
	/*End -- w00135358 add for HG255	 20090925*/

	//printk("===Kernel Debug===Func:%s,Line:%d===mark:0x%x\n",__func__,__LINE__,skb->mark);
...
int ip_mc_output(struct sk_buff *skb)
{
    ...
    /* start add fast routing by f00110348 */
    ...
    /* end add fast routing by f00110348 */
}
...
/* begin, AU8D00832, s63873, 20080730*/
EXPORT_SYMBOL(sysctl_rtp_port_max);
EXPORT_SYMBOL(sysctl_rtp_port_min);
/* end, AU8D00832, s63873, 20080730*/
