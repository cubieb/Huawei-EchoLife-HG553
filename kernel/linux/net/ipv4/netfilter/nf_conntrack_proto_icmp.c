		 ...
		 unsigned int hooknum)
{
	...
	if (inside->ip.frag_off & htons(IP_OFFSET)) {
        ...
        /*start of AU4D01304 by d00107688 2009-02-05 TR069的WAN不能将路由设备反馈的MTU信息与对应的路由项绑定，网关无法上报成功 */
        if (inside->icmp.code != ICMP_FRAG_NEEDED)
        {
		    return -NF_ACCEPT;
        }
        /*end of AU4D01304 by d00107688 2009-02-05 TR069的WAN不能将路由设备反馈的MTU信息与对应的路由项绑定，网关无法上报成功 */
	}
