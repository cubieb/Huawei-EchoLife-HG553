 ...
 *
 * Version:	$Id: route.c,v 1.2 2010/07/10 12:36:10 l43571 Exp $
 *
 * Authors:	Ross Biro
...
/*start of flush of route cache by c00126165 2008-8-20*/
/*start of 支持ARP Attack by c00126165 2008-9-23*/
void ip_rt_run_flush_by_arp(u32 saddr)
{
	int i;
...
/*end of flush of route cache by c00126165 2008-8-20*/
				  ...
				  struct rtable **result)
{
	...
	rth->fl.fl4_tos	= tos;
        ...
        /* start of ATP 2008.01.30 ATPV100R002C01B021 绑定时策略路由无效 AU4D00377 */
        rth->fl.mark = skb->mark;
...
int __init ip_rt_init(void)
{
    ...
    // Set dst cache number(ip_rt_max_size = 2048).
    rhash_entries = 128;
#endif
...
/*start of 支持ARP Attack by c00126165 2008-9-23*/
EXPORT_SYMBOL(ip_rt_run_flush_by_arp);
/*end of 支持ARP Attack by c00126165 2008-9-23*/
