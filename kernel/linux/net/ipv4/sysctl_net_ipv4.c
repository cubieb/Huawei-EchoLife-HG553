 ...
 *
 * $Id: sysctl_net_ipv4.c,v 1.1 2010/07/06 06:45:44 c65985 Exp $
 *
...
extern unsigned int sysctl_icmp_acl_svc[ICMP_SVC_MAX]; 
extern unsigned int sysctl_icmp_acl_addr[ICMP_ADDR_MAX]; 
/* BEGIN: Added by KF19989, 2009/11/18: 增加Automatic ACL ACS */
extern unsigned int icmp_acl_acs_addr;
extern unsigned int icmp_acl_dhcp_addr_1[ICMP_DHCP_AUTOACL_MAX];
extern unsigned int icmp_acl_dhcp_addr_2[ICMP_DHCP_AUTOACL_MAX];
/* END:  Added by KF19989, 2009/11/18: 增加Automatic ACL ACS */
...
/* start of HG553_protocal : Added by c65985, 2010.1.4  static nat HG553V100R001 */
int sysctl_static_nat_enable;
/* end of HG553_protocal : Added by c65985, 2010.1.4  static nat HG553V100R001 */
#ifdef CONFIG_SYSCTL
...
ctl_table ipv4_table[] = {
	...
	{
		.ctl_name	= NET_IPV4_FAST_ROUTING,
		.procname	= "fast_routing",
		.data		= &sysctl_fast_routing,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec,
	},
        /* Communicating with userspace for icmp acl. --c47036 */
        {
            .ctl_name   = NET_IPV4_ICMP_ACL_SVC,
            .procname   = "icmp_acl_svc",
            .data       = &sysctl_icmp_acl_svc,
            .maxlen     = sizeof(sysctl_icmp_acl_svc),
            .mode       = 0644,
            .proc_handler   = &proc_dointvec
        },
        {
            .ctl_name   = NET_IPV4_ICMP_ACL_ADDR,
            .procname   = "icmp_acl_addr",
            .data       = &sysctl_icmp_acl_addr,
            .maxlen     = sizeof(sysctl_icmp_acl_addr),
            .mode       = 0644,
            .proc_handler   = &proc_dointvec
        },
	/* begin, AU8D00832, s63873, 20080730*/
	{
		.ctl_name	= NET_RTP_PORT_MAX,
		.procname	= "rtp_ptmax",
		.data		= &sysctl_rtp_port_max,
		.maxlen		= sizeof(sysctl_rtp_port_max),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec
	},
		{
		.ctl_name	= NET_RTP_PORT_MIN,
		.procname	= "rtp_ptmin",
		.data		= &sysctl_rtp_port_min,
		.maxlen		= sizeof(sysctl_rtp_port_min),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec
	},
	/* end, AU8D00832, s63873, 20080730*/
    /* BEGIN: Added by KF19989, 2009/11/18: 增加Automatic ACL ACS */
	{
		.ctl_name	= NET_IPV4_ICMP_ACL_ACS,
		.procname	= "icmp_acl_acs",
		.data		= &icmp_acl_acs_addr,
		.maxlen		= sizeof(icmp_acl_acs_addr),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec
	}, 
	{
		.ctl_name	= NET_IPV4_ICMP_ACL_DHCP_1,
		.procname	= "icmp_acl_dhcp_1",
		.data		= &icmp_acl_dhcp_addr_1,
		.maxlen		= sizeof(icmp_acl_dhcp_addr_1),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec
	}, 
	{
		.ctl_name	= NET_IPV4_ICMP_ACL_DHCP_2,
		.procname	= "icmp_acl_dhcp_2",
		.data		= &icmp_acl_dhcp_addr_2,
		.maxlen		= sizeof(icmp_acl_dhcp_addr_2),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec
	}, 
	/* END:  Added by KF19989, 2009/11/18: 增加Automatic ACL ACS */
    /* start of HG553_protocal : Added by c65985, 2010.1.4  static nat HG553V100R001 */
    {
		.ctl_name	= NET_STATIC_NAT_ENABLE,
		.procname	= "static_nat_enable",
		.data		= &sysctl_static_nat_enable,
		.maxlen		= sizeof(sysctl_static_nat_enable),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec
	},
    /* end of HG553_protocal : Added by c65985, 2010.1.4 HG553V100R001 */
	{ .ctl_name = 0 }
};
...
/* start of HG553_protocal : Added by c65985, 2010.1.4  static nat HG553V100R001 */
EXPORT_SYMBOL(sysctl_static_nat_enable);
/* end of HG553_protocal : Added by c65985, 2010.1.4 HG553V100R001 */
