...
static int kill_h323(const struct nf_conn *i, void *data)
{    
...
void nf_conntrack_user_cleanup(void)
{
    switch (nf_conntrack_clean)
    {
        ...
        case 1: 
            // clean dns conntrack
            nf_ct_iterate_cleanup(kill_dns, NULL);
            break;
        case 2: 
            // clean sip conntrack
            nf_ct_iterate_cleanup(kill_sip, NULL);
            break;
        case 3:
            // clean h323 conntrack
            nf_ct_iterate_cleanup(kill_h323, NULL); 
            break;
        case 9: 
            // clean all for debug
            nf_ct_iterate_cleanup(kill_all, NULL);
...
/*end of 问题单:AU4D00925，连接跟踪信息清空。by 00126165 2009-10-25*/           
        default: 
            // clean by dest port
            nf_ct_iterate_cleanup(kill_dport, &nf_conntrack_clean);
            break;            
    }
