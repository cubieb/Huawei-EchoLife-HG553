...
#include "flash_api.h"
 ...
 /*start of  flash 3.3.1 porting by l39225 20060504*/
#include <linux/spinlock.h>  
static spinlock_t write_flash_lock= SPIN_LOCK_UNLOCKED;
static spinlock_t read_flash_lock= SPIN_LOCK_UNLOCKED;
/*end of  flash 3.3.1 porting by l39225 20060504*/

DECLARE_MUTEX(write_sem_lock);
EXPORT_SYMBOL(write_sem_lock);
...
#define MANUFACTURER_ID_SST      0x00   //to be done
#define MANUFACTURER_ID_INTEL    0x00   //to be done

#ifndef _CFE_
#define CF_FLASH_SCHED_BYTES 256
...
#define FLASH_SUSPEND   7       /* suspend */
#define FLASH_RESUME    8       /* resume */
...
/*2009-02-14 w45260:
注意一些Flash具有相同的device id(但Manufacture id 不同).
HG553 italy/spain 优先识别显示为16M的 MX29LV128D 和 S29GL128
*/


#define ID_COMMON_DEVICE_ID_227E   0x227E  
#define ID_COMMON_DEVICE_ID_2200   0x2200  
#define ID_COMMON_DEVICE_ID_2201   0x2201

#define ID_MX29LV128DB  0x227A   /*size:8KBx8 + 64KBx255; Device ID: x01-->227A*/
#define ID_MX29LV128DT  0x227E   /*size:8KBx8 + 64KBx255; Device ID: x01-->227E*/
#define ID_S29GL128N    0x2201   /*size:128KB x128 ; Device ID: x01-->227E ;0x0E-->0x2221 ;0x0F-->0x2201*/

#define ID_AM29LV320MB  0x2200   /*size:8KBx8 + 64KB x63; Device ID: x01-->227E ;0x0E-->0x221A ;0x0F-->0x2200*/
#define ID_AM29LV320MT  0x2201   /*size:8KBx8 + 64KB x63; Device ID: x01-->227E ;0x0E-->0x221A ;0x0F-->0x2201*/
#define ID_AM29LV320DB  0x22F9   /*size:8KBx8 + 64KB x63; Device ID: x01-->0x22F9 */
#define ID_AM29LV320DT  0x22F6   /*size:8KBx8 + 64KB x63; Device ID: x01-->0x22F6 */

#define ID_MX29LV320M   0x2200   /*size:64KB x64; Device ID: x01-->227E ;0x0E-->0x221D ;0x0F-->0x2200*/
#define ID_MX29LV640FT  0x22ED
...
#define CFI_FLASH_DEVICES                   \
         {{ID_MX29LV128DT, "MX29LV128DT", MANUFACTURER_ID_MXIC},  \
          {ID_MX29LV128DB, "mx29LV128DB", MANUFACTURER_ID_MXIC},  \
          {ID_S29GL128N,   "S29GL128N",   MANUFACTURER_ID_SPANSION},\
          {ID_AM29DL800T,  "AM29DL800T",  MANUFACTURER_ID_AMD},    \
          {ID_AM29DL800B,  "AM29DL800B",  MANUFACTURER_ID_AMD},    \
          {ID_AM29LV800T,  "AM29LV800T",  MANUFACTURER_ID_AMD},    \
          {ID_AM29LV800B,  "AM29LV800B",  MANUFACTURER_ID_AMD},    \
          {ID_AM29LV400B,  "AM29LV400B",  MANUFACTURER_ID_AMD},    \
          {ID_AM29LV200BT, "AM29LV200BT", MANUFACTURER_ID_AMD},  \
          {ID_AM29LV160B,  "AM29LV160B",  MANUFACTURER_ID_AMD},    \
          {ID_AM29LV160T,  "AM29LV160T",  MANUFACTURER_ID_AMD},    \
          {ID_AM29LV320T,  "AM29LV320T",  MANUFACTURER_ID_AMD},    \
          {ID_MX29LV320AT, "MX29LV320AT", MANUFACTURER_ID_MXIC},  \
          {ID_AM29LV320B,  "AM29LV320B",  MANUFACTURER_ID_AMD},    \
          {ID_MX29LV320AB, "MX29LV320AB", MANUFACTURER_ID_MXIC},  \
          {ID_AM29LV320MB, "AM29LV320MB", MANUFACTURER_ID_AMD},  \
          {ID_AM29LV320MT, "AM29LV320MT", MANUFACTURER_ID_AMD},  \
          {ID_MX29LV320M,  "MX29LV320M",  MANUFACTURER_ID_MXIC},  \
          {ID_MX29LV640BT, "MX29LV640BT", MANUFACTURER_ID_MXIC}, \
          {ID_MX29LV640FT, "MX29LV640FT", MANUFACTURER_ID_MXIC},  \
          {ID_SST39VF200A, "SST39VF200A", MANUFACTURER_ID_SST},  \
          {ID_SST39VF400A, "SST39VF400A", MANUFACTURER_ID_SST},  \
          {ID_SST39VF800A, "SST39VF800A", MANUFACTURER_ID_SST},  \
          {ID_SST39VF1601, "SST39VF1601", MANUFACTURER_ID_SST},  \
          {ID_SST39VF3201, "SST39VF3201", MANUFACTURER_ID_SST},  \
          {ID_I28F160C3T,  "I28F160C3T",  MANUFACTURER_ID_INTEL},\
          {ID_I28F160C3B,  "I28F160C3B",  MANUFACTURER_ID_INTEL},\
          {ID_I28F320C3T,  "I28F320C3T",  MANUFACTURER_ID_INTEL},\
          {ID_I28F320C3B,  "I28F320C3B",  MANUFACTURER_ID_INTEL},\
          {ID_I28F640J3,   "I28F640J3",   MANUFACTURER_ID_INTEL},\
          {0, ""}                           \
        }
...
static unsigned short g_ManufId ;
extern int g_iReset;
...
int cfi_flash_init(flash_device_info_t **flash_info)
{
    ...
    *flash_info = &flash_cfi_dev;
	...
	case ID_I28F640J3:
        ...
        case ID_MX29LV320AB:
		case ID_MX29LV128DB:	
        case ID_COMMON_DEVICE_ID_2200:  /*ID_AM29LV320MB/ID_MX29LV320M*/
        case ID_AM29DL800T:
        case ID_AM29LV800T:
        case ID_AM29LV160T:
        case ID_AM29LV320T:
        case ID_MX29LV320AT:
		case ID_MX29LV128DT:
        case ID_COMMON_DEVICE_ID_2201:  /*ID_AM29LV320MT/ID_S29GL128N*/
        case ID_AM29LV200BT:
        case ID_MX29LV640BT:
        case ID_MX29LV640FT:
	...
	printk( "@@@cfi_flash_init: device id:0x%X!\n",device_id );
    ...
    switch (device_id)
    {
        case ID_AM29DL800B:
        case ID_AM29LV800B:
        /*start of  flash 3.3.2 porting by l39225 20060504*/
        //case ID_AM29LV400B:
        /*end of  flash 3.3.2 porting by l39225 20060504*/
        case ID_AM29LV160B:
        case ID_AM29LV320B:
        case ID_MX29LV320AB:
		case ID_MX29LV128DB:	
    ...
    if( flash_cfi_dev.flash_device_name[0] == '\0' ) {
        for( fnfi_ptr = fnfi; fnfi_ptr->fnfi_id != 0; fnfi_ptr++ ) {
            if((fnfi_ptr->manuf_id == g_ManufId) && (fnfi_ptr->fnfi_id == device_id)) {
   ...
   /*start of  flash 3.3.3 porting by l39225 20060504*/
   if ((ID_AM29LV320MB == device_id ) || (ID_AM29LV320MT ==device_id) || (ID_S29GL128N == device_id))
   {
       *(volatile unsigned int*)(0xfffe2004) |= 0x00000006; /* if spansion flash CS0 wait time -> Three*/
   }
   /*end of  flash 3.3.3 porting by l39225 20060504*/
    /* 判断FLASH的末尾是否由8个8k的小块组成 */
    for ( i = (count-8); i < count; i++)
    {
    	if (meminfo.sec[i].size != 8*1024)
    	{
    	    g_FlashTopDevice = 0;
    	    break;   		
    	}
   	...
   	printk( "@@@cfi_flash_init OK: g_FlashTopDevice:%d!\n",g_FlashTopDevice );
...
#ifndef _CFE_
    if (!in_interrupt()) {
        down_interruptible(&write_sem_lock);
    }
#endif
...
static int cfi_memcmp_sched(unsigned char *s1, unsigned char *s2, int nb)
{
    ...
    const unsigned int sched_chunk = 1 * 1024;
    ...
    int nbytes)
{
    ...
    if (!g_iReset)
    {
		spin_lock_irq(write_flash_lock);
    }
	...
	if (!g_iReset)
	{
		spin_unlock_irq(write_flash_lock);
	}
...
static unsigned short cfi_flash_get_device_id(void)
{
    ...
    /* w45260:HG553 需要同时支持 16M的 ID_MX29LV128D 和 ID_S29GL128N */
	g_ManufId = *(fwp + 0x0);
    answer = *(fwp + 1);
    printk("\n@@@@Flash Manufacture id :%x\n",g_ManufId);
    if (ID_COMMON_DEVICE_ID_227E == answer ) {
        answer = *(fwp + 0xe);
        answer = *(fwp + 0xf);
		if((ID_COMMON_DEVICE_ID_2200 != answer) 
			&& (ID_COMMON_DEVICE_ID_2201 != answer) )
		{
		    answer = ID_MX29LV128DT;
		}	
    }
