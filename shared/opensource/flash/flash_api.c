...
/***************************************************************************
 * Function Name: JudgeFlashIsTopDevice8K
 * Description  : 判断FLASH的最后64K是否由8×8K组成.
 * Returns      : 1： 表示FLASH的最后64K是否由8×8K组成 
 *                0： 表示不是
 * Author       : yuyouqing
 ***************************************************************************/
int JudgeFlashIsTopDevice8K(void)
{
    return g_FlashTopDevice;	
}
