...
/*增加VDF版本特殊TAG号 l65130 2008-01-29 start */
#define HW_VDF_HG553        "7"
/*增加VDF版本特殊TAG号 l65130 2008-01-29 end */
...
/* BEGIN: Modified by w00135358, 2010/08/26: set FTTX flag*/
//#define DOUBLE_LEN            8
#define FTTX_FLAG_LEN            8
/* END: Modified by w00135358, 2010/08/26: set FTTX flag*/
#define ERASEPSI_LEN          8
/* start of maintain Auto Upgrade by zhangliang 60003055 2006年5月8日"
...
#define RESERVED_LEN    (TAG_LEN - TAG_VER_LEN - SIG_LEN - SIG_LEN_2 - \
                         CHIP_ID_LEN - BOARD_ID_LEN - (4*IMAGE_LEN) - \
                         (3*ADDRESS_LEN) - (3*FLAG_LEN) - (2*TOKEN_LEN) - \
                         PRODUCT_NAME_LEN - SOFT_VERSION_LEN - FTTX_FLAG_LEN - ERASEPSI_LEN)
/* end of maintain Auto Upgrade by zhangliang 60003055 2006年5月8日" */
...
typedef struct _FILE_TAG
{
    ...
    /* end of maintain Auto Upgrade by zhangliang 60003055 2006年5月8日" */
    unsigned char acFTTx[FTTX_FLAG_LEN];
    unsigned char erasePSI[ERASEPSI_LEN];
