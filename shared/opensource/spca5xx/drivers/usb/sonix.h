...
static int sonix_sofdetect(struct usb_spca50x *spca50x,struct spca50x_frame *frame, unsigned char *cdata,int *iPix, int seqnum,int *datalength);
/******************************************************************/
static void sonix_setcolors(struct usb_spca50x *spca50x){}
static __u16 sonix_getcolors(struct usb_spca50x *spca50x){return 0;}
static void sonix_shutdown(struct usb_spca50x *spca50x){}
static void sonix_setAutobright(struct usb_spca50x *spca50x){}
static void sonix_setquality(struct usb_spca50x *spca50x){}
static void sonix_stop0(struct usb_spca50x *spca50x){}
...
static int sonix_i2cwrite(struct usb_device *dev, __u8 * buffer,
			  __u16 length)
{
    int retry = 60;
...
static int tas5110_I2cinit(struct usb_spca50x *spca50x)
{
    int i = 0;
...
static int hv7131_I2cinit(struct usb_spca50x *spca50x)
{
    int i = 0;
...
static int pas202_I2cinit(struct usb_spca50x *spca50x)
{
    int i = 0;
