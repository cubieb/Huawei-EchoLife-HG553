...
//static const char SPCA50X_H_CVS_VERSION[]="$Id: spca5xx.h,v 1.1 2010/07/05 13:00:29 c65985 Exp $";
...
struct usb_spca50x {
    ...
    volatile int user;			/* user count for exclusive use */
    ...
    int userPid;             /* user mode application process pid */
