 ...
 *
 * libipt_ecn_j.c borrowed heavily from libipt_dscp_j.c
 *
 * $Id: libipt_ecn_j.c,v 1.1 2010/07/05 14:40:05 l43571 Exp $
 */
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
{
	unsigned int result;
	struct ipt_ecn_j_info *einfo
		= (struct ipt_ecn_j_info *)(*target)->data;
...
print(const struct ipt_ip *ip,
      ...
      int numeric)
{
	const struct ipt_ecn_j_info *einfo =
		(const struct ipt_ecn_j_info *)target->data;
...
= { NULL,
    "ECN",
    IPTABLES_VERSION,
    IPT_ALIGN(sizeof(struct ipt_ecn_j_info)),
    IPT_ALIGN(sizeof(struct ipt_ecn_j_info)),
    &help,
    &init,
    &parse,
