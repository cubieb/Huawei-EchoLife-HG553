 ...
 *
 * $Id: libipt_ttl_j.c,v 1.1 2010/07/05 14:40:07 l43571 Exp $
 *
...
{
	struct ipt_ttl_j_info *info = (struct ipt_ttl_j_info *) (*target)->data;
	u_int8_t value;
...
{
	const struct ipt_ttl_j_info *info = 
		(struct ipt_ttl_j_info *) target->data;
...
struct iptables_target TTL = { NULL, 
	"TTL",
	IPTABLES_VERSION,
	IPT_ALIGN(sizeof(struct ipt_ttl_j_info)),
	IPT_ALIGN(sizeof(struct ipt_ttl_j_info)),
	&help,
	&init,
	&parse,
