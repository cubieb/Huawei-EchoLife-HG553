...
struct config {
	...
	const char *locate;
	int input;//The video input to be used,8 is usb
	int norm;//video设备标准,PAL/NTSC/SECAM
	int frame_limit;
	int quiet;
	int ppm;
	int noise;
...
void get_lanconf(void);//add by z67625 for get lan ip start and end from conf
