...
void load_interfaces(void)
{
    ...
    //printf("\n==load_interfaces start===file:%s,line:%d===\n",__FILE__,__LINE__);
    ...
    //printf("\n=调用get_interfaces前==total_probed=%d==file:%s,line:%d===\n",total_probed,__FILE__,__LINE__);
    total_probed = get_interfaces(ifaces, MAX_INTERFACES);
    //printf("\n===调用get_interfaces后total_probed=%d==file:%s,line:%d===\n",total_probed,__FILE__,__LINE__);
    ...
    if (!ptr || !*ptr || !**ptr) {
        ...
        if (total_probed <= 0) {
          //  printf("\n=exit from here====file:%s,line:%d===\n",__FILE__,__LINE__);
            //printf("\n===ERROR: Could not determine network interfaces, you must use a interfaces config line==file:%s,line:%d===\n",__FILE__,__LINE__);
            DEBUG(0,("ERROR: Could not determine network interfaces, you must use a interfaces config line\n"));
            exit(1);
        }
  /*added by lvxin@20081008*/
        for (i=0;i<total_probed;i++) {
            //printf("\n==i=%d===file:%s,line:%d===\n",i,__FILE__,__LINE__);
