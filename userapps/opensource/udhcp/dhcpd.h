...
#include "leases.h"
	...
	#define VDF_OPTION
#endif
#ifndef SUPPORT_VDF_DHCP
	#define SUPPORT_VDF_DHCP
#endif
...
#define DHCP_OUTBOUND_PROXY      0x78

/*start songchen:add for VF IP Phone dhcp optioins,20090414*/
#define DHCP_TFTP_SERVER_VDF	  0x42
#define DHCP_TFTP_SERVER_NAME_VDF 0x96
/*end for more dhcp optioins*/
#ifdef VDF_OPTION
...
struct server_config_t {
    ...
    /*start of  增加 vdf ip phone 功能 by s53329 at  20090409*/
	#define DHCPOPTION60LEN_VDF 1024
    #define COMMONOPTIONLEN_VDF 256
    char *pIPPhoneDomainName;
    char *pIPPhoneDNSServers;
    char *pIPPhoneTFTPServer;
    char *pIPPhoneTFTPServerName;
    char *pOutBoundProxy;
    char *pDhcpOpt60;
    int  iIPPhoneVLANQoSEnable;
    /*end of  增加 vdf ip phone 功能 by s53329 at  20090409*/
    u_int32_t iPPhoneNtp1;
    u_int32_t iPPhoneNtp2;							
